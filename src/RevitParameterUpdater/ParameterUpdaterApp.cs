...
namespace RevitParameterUpdater
{
    ...
    internal class Updater
    {
        ...
        private static readonly (string keyword, MaterialFunctionAssignment func)[] s_layerFuncKeywords =
        {
            ...
            ("substrate 1", MaterialFunctionAssignment.Substrate),
            ("substrate1",  MaterialFunctionAssignment.Substrate),
            ("substrate 2", MaterialFunctionAssignment.Substrate),
            ("substrate2",  MaterialFunctionAssignment.Substrate),
            ...
            ("air",         MaterialFunctionAssignment.Insulation),
        };
